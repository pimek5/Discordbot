...
CHAMPIONS = {
    ...
    'Alistar': {'gender': 'Male', 'position': 'Support', 'species': 'Minotaur', 'resource': 'Mana', 'range': 'Melee', 'region': 'Runeterra'},
    ...
    'Annie': {'gender': 'Female', 'position': 'Middle', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Noxus'},
    ...
    'Cassiopeia': {'gender': 'Female', 'position': 'Middle', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Noxus'},
    'Cho\'Gath': {'gender': 'Male', 'position': 'Top', 'species': 'Void-Being', 'resource': 'Mana', 'range': 'Melee', 'region': 'Void'},
    'Corki': {'gender': 'Male', 'position': 'Middle', 'species': 'Yordle', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Bandle City'},
    'Darius': {'gender': 'Male', 'position': 'Top', 'species': 'Human', 'resource': 'Manaless', 'range': 'Melee', 'region': 'Noxus'},
    'Diana': {'gender': 'Female', 'position': 'Jungle', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Targon'},
    'Dr. Mundo': {'gender': 'Male', 'position': 'Top', 'species': 'Human', 'resource': 'Manaless', 'range': 'Melee', 'region': 'Zaun'},
    'Draven': {'gender': 'Male', 'position': 'Bottom', 'species': 'Human', 'resource': 'Manaless', 'range': 'Ranged', 'region': 'Noxus'},
    'Ekko': {'gender': 'Male', 'position': 'Middle', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Zaun'},
    'Elise': {'gender': 'Female', 'position': 'Jungle', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Shadow Isles'},
    ...
    'Fiddlesticks': {'gender': 'Male', 'position': 'Jungle', 'species': 'Demon', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Runeterra'},
    ...
    'Gnar': {'gender': 'Male', 'position': 'Top', 'species': 'Yordle', 'resource': 'Rage', 'range': 'Ranged', 'region': 'Freljord'},
    'Gragas': {'gender': 'Male', 'position': 'Jungle', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Freljord'},
    'Graves': {'gender': 'Male', 'position': 'Jungle', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Bilgewater'},
    'Gwen': {'gender': 'Female', 'position': 'Top', 'species': 'Doll', 'resource': 'Mana', 'range': 'Melee', 'region': 'Shadow Isles'},
    'Hecarim': {'gender': 'Male', 'position': 'Jungle', 'species': 'Undead', 'resource': 'Mana', 'range': 'Melee', 'region': 'Shadow Isles'},
    'Heimerdinger': {'gender': 'Male', 'position': 'Middle', 'species': 'Yordle', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Piltover'},
    ...
    'Jarvan IV': {'gender': 'Male', 'position': 'Jungle', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Demacia'},
    'Jax': {'gender': 'Male', 'position': 'Top', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Icathia'},
    'Jayce': {'gender': 'Male', 'position': 'Top', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Piltover'},
    ...
    'Kai\'Sa': {'gender': 'Female', 'position': 'Bottom', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Void'},
    ...
    'Kassadin': {'gender': 'Male', 'position': 'Middle', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Void'},
    ...
    'Kayn': {'gender': 'Male', 'position': 'Jungle', 'species': 'Human', 'resource': 'Manaless', 'range': 'Melee', 'region': 'Ionia'},
    'Kennen': {'gender': 'Male', 'position': 'Top', 'species': 'Yordle', 'resource': 'Energy', 'range': 'Ranged', 'region': 'Ionia'},
    ...
    'Malzahar': {'gender': 'Male', 'position': 'Middle', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Void'},
    ...
    'Mordekaiser': {'gender': 'Male', 'position': 'Top', 'species': 'Undead', 'resource': 'Shield', 'range': 'Melee', 'region': 'Noxus'},
    'Morgana': {'gender': 'Female', 'position': 'Support', 'species': 'God', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Demacia'},
    'Naafiri': {'gender': 'Female', 'position': 'Middle', 'species': 'Darkin', 'resource': 'Manaless', 'range': 'Melee', 'region': 'Shurima'},
    'Nami': {'gender': 'Female', 'position': 'Support', 'species': 'Vastaya', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Runeterra'},
    ...
    'Nidalee': {'gender': 'Female', 'position': 'Jungle', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Ixtal'},
    ...
    'Nunu & Willump': {'gender': 'Male', 'position': 'Jungle', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Freljord'},
    ...
    'Pantheon': {'gender': 'Male', 'position': 'Middle', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Targon'},
    'Poppy': {'gender': 'Female', 'position': 'Top', 'species': 'Yordle', 'resource': 'Mana', 'range': 'Melee', 'region': 'Demacia'},
    'Pyke': {'gender': 'Male', 'position': 'Support', 'species': 'Undead', 'resource': 'Manaless', 'range': 'Melee', 'region': 'Bilgewater'},
    'Qiyana': {'gender': 'Female', 'position': 'Middle', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Ixtal'},
    'Quinn': {'gender': 'Female', 'position': 'Top', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Demacia'},
    'Rakan': {'gender': 'Male', 'position': 'Support', 'species': 'Vastaya', 'resource': 'Mana', 'range': 'Melee', 'region': 'Ionia'},
    'Rammus': {'gender': 'Male', 'position': 'Jungle', 'species': 'Armadillo', 'resource': 'Mana', 'range': 'Melee', 'region': 'Shurima'},
    'Rek\'Sai': {'gender': 'Female', 'position': 'Jungle', 'species': 'Void-Being', 'resource': 'Rage', 'range': 'Melee', 'region': 'Void'},
    ...
    'Rengar': {'gender': 'Male', 'position': 'Jungle', 'species': 'Vastaya', 'resource': 'Ferocity', 'range': 'Melee', 'region': 'Ixtal'},
    ...
    'Ryze': {'gender': 'Male', 'position': 'Middle', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Runeterra'},
    ...
    'Senna': {'gender': 'Female', 'position': 'Support', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Shadow Isles'},
    'Seraphine': {'gender': 'Female', 'position': 'Support', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Piltover'},
    'Sett': {'gender': 'Male', 'position': 'Top', 'species': 'Vastaya', 'resource': 'Grit', 'range': 'Melee', 'region': 'Ionia'},
    'Shaco': {'gender': 'Male', 'position': 'Jungle', 'species': 'Demon', 'resource': 'Mana', 'range': 'Melee', 'region': 'Runeterra'},
    'Shen': {'gender': 'Male', 'position': 'Top', 'species': 'Human', 'resource': 'Energy', 'range': 'Melee', 'region': 'Ionia'},
    'Shyvana': {'gender': 'Female', 'position': 'Jungle', 'species': 'Dragon', 'resource': 'Fury', 'range': 'Melee', 'region': 'Demacia'},
    ...
    'Sona': {'gender': 'Female', 'position': 'Support', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Ionia'},
    ...
    'Taliyah': {'gender': 'Female', 'position': 'Jungle', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Shurima'},
    ...
    'Trundle': {'gender': 'Male', 'position': 'Top', 'species': 'Troll', 'resource': 'Mana', 'range': 'Melee', 'region': 'Freljord'},
    ...
    'Udyr': {'gender': 'Male', 'position': 'Jungle', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Freljord'},
    'Urgot': {'gender': 'Male', 'position': 'Top', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Zaun'},
    'Varus': {'gender': 'Male', 'position': 'Bottom', 'species': 'Darkin', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Ionia'},
    'Vayne': {'gender': 'Female', 'position': 'Bottom', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Demacia'},
    'Veigar': {'gender': 'Male', 'position': 'Middle', 'species': 'Yordle', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Bandle City'},
    ...
    'Viktor': {'gender': 'Male', 'position': 'Middle', 'species': 'Human', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Zaun'},
    'Vladimir': {'gender': 'Male', 'position': 'Middle', 'species': 'Human', 'resource': 'Manaless', 'range': 'Ranged', 'region': 'Noxus'},
    'Volibear': {'gender': 'Male', 'position': 'Jungle', 'species': 'God', 'resource': 'Mana', 'range': 'Melee', 'region': 'Freljord'},
    'Warwick': {'gender': 'Male', 'position': 'Jungle', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Zaun'},
    'Wukong': {'gender': 'Male', 'position': 'Top', 'species': 'Vastaya', 'resource': 'Mana', 'range': 'Melee', 'region': 'Ionia'},
    'Xayah': {'gender': 'Female', 'position': 'Bottom', 'species': 'Vastaya', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Ionia'},
    'Xerath': {'gender': 'Male', 'position': 'Middle', 'species': 'God-Warrior', 'resource': 'Mana', 'range': 'Ranged', 'region': 'Shurima'},
    'Xin Zhao': {'gender': 'Male', 'position': 'Jungle', 'species': 'Human', 'resource': 'Mana', 'range': 'Melee', 'region': 'Demacia'},
    'Yasuo': {'gender': 'Male', 'position': 'Middle', 'species': 'Human', 'resource': 'Flow', 'range': 'Melee', 'region': 'Ionia'},
    'Yone': {'gender': 'Male', 'position': 'Middle', 'species': 'Spirit', 'resource': 'Flow', 'range': 'Melee', 'region': 'Ionia'},
